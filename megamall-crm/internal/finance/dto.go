...
type FinanceOrdersSummary struct {
	...
	ProductCost        float64 `json:"product_cost"`         // SUM(orders.product_cost) — exact FIFO cost, from either the main-warehouse or courier-warehouse fulfilment path (see deductInventory)
