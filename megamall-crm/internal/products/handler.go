...
func (h *Handler) ListCategories(c *gin.Context) {
	...
	cats, total, err := h.svc.ListCategories(c.Request.Context(), p)
	if err != nil {
	...
	for i := range cats {
		out = append(out, ToCategoryResponse(&cats[i]))
	}
...
func (h *Handler) CreateCategory(c *gin.Context) {
	...
	cat, err := h.svc.CreateCategory(c.Request.Context(), claims.UserID, req)
	if err != nil {
		response.HandleError(c, err)
		return
	}
...
func (h *Handler) UpdateCategory(c *gin.Context) {
	...
	claims := middleware.ClaimsFromContext(c)
	cat, err := h.svc.UpdateCategory(c.Request.Context(), claims.UserID, id, req)
	if err != nil {
		response.HandleError(c, err)
		return
	}
...
func (h *Handler) DeleteCategory(c *gin.Context) {
	...
	claims := middleware.ClaimsFromContext(c)
	if err := h.svc.DeleteCategory(c.Request.Context(), claims.UserID, id); err != nil {
		response.HandleError(c, err)
		return
	}
