...
var defaultCommissionRates = []defaultRate{
	...
	{compensation.CommissionTypeManagerTeamRate, 0.03000, "default global manager team commission (3%)"},
	{compensation.CommissionTypeManagerPersonalRate, 0.20000, "default global manager personal commission (20%)"},
	{compensation.CommissionTypeTeamLeadPoolRate, 0.40000, "default global team lead pool (40%)"},
	{compensation.CommissionTypeCompanyRate, 0.60000, "default global company revenue (60%)"},
}
