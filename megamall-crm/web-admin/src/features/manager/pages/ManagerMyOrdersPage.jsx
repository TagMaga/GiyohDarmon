...
function DesktopRow({ order, onView, onEdit }) {
  ...
  return (
    <tr className="border-b border-slate-50 hover:bg-slate-50/60 transition-colors">
      ...
      <td className="px-4 py-3 text-xs font-semibold text-slate-800 whitespace-nowrap text-right">{fmtAmount(amount)} с</td>
      <td className="px-4 py-3 text-xs font-semibold text-emerald-700 whitespace-nowrap text-right">{fmtAmount(net)} с</td>
  ...
  return (
    <div className="card p-4 space-y-2">
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <span className="text-sm font-bold text-slate-800">{fmtAmount(amount)} с</span>
      </div>
    ...
    <div className="card p-4">
      <div className="grid grid-cols-4 gap-4 text-center">
        {[
          ...
          { label: 'Выручка', value: `${fmtAmount(revenue)} с`, cls: 'text-violet-700' },
