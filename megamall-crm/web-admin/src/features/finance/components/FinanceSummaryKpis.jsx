  ...
  const cards = [
    {
      ...
      value: `${fmtMoney(orders.total_sales)} с`,
      dot: 'bg-sky-500',
      tone: 'text-sky-950',
    ...
    },
    {
      ...
      value: `${fmtMoney(orders.courier_payout)} с`,
      dot: 'bg-violet-500',
    ...
    },
    {
      ...
      value: `${fmtMoney(orders.team_payouts)} с`,
      dot: 'bg-amber-500',
      tone: 'text-amber-950',
    ...
    },
    {
      ...
      value: `${fmtMoney(orders.product_cost)} с`,
      dot: 'bg-emerald-500',
    ...
    {
      label: 'Зарплаты',
      value: `${fmtMoney(expenses.salaries)} с`,
      dot: 'bg-cyan-500',
      tone: 'text-cyan-950',
    ...
    {
      label: 'Аренда',
      value: `${fmtMoney(expenses.rent)} с`,
      dot: 'bg-teal-500',
      tone: 'text-teal-950',
    ...
    {
      label: 'Маркетинг',
      value: `${fmtMoney(expenses.marketing)} с`,
      dot: 'bg-fuchsia-500',
    ...
    {
      label: 'Налоги',
      value: `${fmtMoney(expenses.taxes)} с`,
      dot: 'bg-slate-500',
      tone: 'text-slate-950',
    ...
    },
    {
      ...
      value: `${fmtMoney(expenses.other_business_expenses)} с`,
      dot: 'bg-orange-500',
    ...
    },
    {
      ...
      value: `${fmtMoney(expenses.net_profit)} с`,
      dot: 'bg-rose-500',
      tone: 'text-rose-950',
