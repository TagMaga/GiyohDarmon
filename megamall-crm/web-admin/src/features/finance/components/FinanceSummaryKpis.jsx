  ...
  const cards = [
    {
      ...
      value: `${fmtMoney(orders.total_sales)} смн`,
      dot: 'bg-sky-500',
      tone: 'text-sky-950',
    ...
    },
    {
      ...
      value: `${fmtMoney(orders.courier_payout)} смн`,
      dot: 'bg-violet-500',
    ...
    },
    {
      ...
      value: `${fmtMoney(orders.team_payouts)} смн`,
      dot: 'bg-amber-500',
      tone: 'text-amber-950',
    ...
    },
    {
      ...
      value: `${fmtMoney(orders.product_cost)} смн`,
      dot: 'bg-emerald-500',
    ...
    {
      label: 'Зарплаты',
      value: `${fmtMoney(expenses.salaries)} смн`,
      dot: 'bg-cyan-500',
      tone: 'text-cyan-950',
    ...
    {
      label: 'Аренда',
      value: `${fmtMoney(expenses.rent)} смн`,
      dot: 'bg-teal-500',
      tone: 'text-teal-950',
    ...
    {
      label: 'Маркетинг',
      value: `${fmtMoney(expenses.marketing)} смн`,
      dot: 'bg-fuchsia-500',
    ...
    {
      label: 'Налоги',
      value: `${fmtMoney(expenses.taxes)} смн`,
      dot: 'bg-slate-500',
      tone: 'text-slate-950',
    ...
    },
    {
      ...
      value: `${fmtMoney(expenses.other_business_expenses)} смн`,
      dot: 'bg-orange-500',
    ...
    },
    {
      ...
      value: `${fmtMoney(expenses.net_profit)} смн`,
      dot: 'bg-rose-500',
      tone: 'text-rose-950',
