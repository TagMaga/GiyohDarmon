...
echo ""
echo "   NOTE: courier and seller PROFILES survive, but every delivery a"
echo "   courier completed and every sale a seller made is recorded only"
echo "   on the order rows being deleted here — that history is gone too."
echo ""
